...
var _ fyne.Theme = (*NeovimTheme)(nil)

func NewNeovimTheme() *NeovimTheme {
	return &NeovimTheme{}
}

func (t *NeovimTheme) Color(name fyne.ThemeColorName, variant fyne.ThemeVariant) color.Color {
	switch name {
...
func (t *NeovimTheme) Icon(name fyne.ThemeIconName) fyne.Resource {
	return theme.DefaultTheme().Icon(name)
}

func (t *NeovimTheme) Font(style fyne.TextStyle) fyne.Resource {
	return theme.DefaultTheme().Font(style)
}

func (t *NeovimTheme) Size(name fyne.ThemeSizeName) float32 {
	switch name {
